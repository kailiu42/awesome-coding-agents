...
| 👀 | [codex-fixes](https://github.com/zhuhaow/codex-fixes) | codex, diagnostics, fixes | Community-maintained CLI for Codex bug diagnostics, issue manifests, and platform-scoped workaround scripts |
