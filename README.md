...
| 👀 | [Agent Island](https://github.com/tristan666666/agent-island) | macos, windows, status, local-first | Open-source status companion for Claude Code, Codex, Gemini, Grok and Cursor with live session state, your-turn alerts, and locally computed usage and cost |
